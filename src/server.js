...
// import ngrok from "@ngrok/ngrok"; // disable in production
...
// Example cron job (disabled for now)
// cron.schedule("0 * * * *", () => {
//   runMissedJoinJob();
// });
...
// IMPORTANT: bind to 0.0.0.0 for Docker/Vercel
server.listen(PORT, "0.0.0.0", () =>
  console.log(`🚀 Node.js web server running at http://0.0.0.0:${PORT}`)
);
